...
{
    public partial class getRootanks : Form
    {
        tanks tank1;
        public getRootanks(tanks tank2)
        {
            InitializeComponent();
            tank1 = tank2;
        }

        private void getRootanks_Load(object sender, EventArgs e)
        {
            try
            {

                double t = double.Parse(tank1.txtt.Text);
                double b = double.Parse(tank1.txtb.Text);
                double fcu = double.Parse(tank1.txtfcu.Text);
                double fy = double.Parse(tank1.txtfy.Text);

                double cover = double.Parse(tank1.txtc.Text);
                double M = double.Parse(tank1.txtMu.Text);
                double P = double.Parse(tank1.txtPu.Text);
                ...
                double As11 = 1.0 * fcu * Math.Pow(10, -4) * b * t;          // mm2
                double As21 =  As11;
                ...
                // Assume a > ab 
                double a61 = ab1 + 80;        // mm  تم فرض الرقم 80 مثلا ليلائم ابعاد البلاطات لانها صغيرة
                double C61 = 1.25 * a61;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if(double.Parse(txtro1.Text) < 1.0)
            {
                MessageBox.Show("Minimum Value of ρ =1.0 ", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtro1.Focus();
                txtro1.SelectAll();
                return;
            }
