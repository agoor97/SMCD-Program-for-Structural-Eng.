...
namespace Design_Concrete
{
    public partial class Interaction : Form
    {
        ...
        PMCOL pmcol;
        public Interaction(PMCOL pmcol2)
        {
            InitializeComponent();
            pmcol = pmcol2;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                if (double.Parse(txtro.Text) < 1.0)
                {
        ...
        private void Interaction_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                double t = double.Parse(pmcol.txtt.Text);
                double b = double.Parse(pmcol.txtb.Text);
                double fcu = double.Parse(pmcol.txtfcu.Text);
                double fy = double.Parse(pmcol.txtfy.Text);
                double cover = double.Parse(pmcol.txtc.Text);
                double M = double.Parse(pmcol.txtm.Text);
                double P = double.Parse(pmcol.txtp.Text);
                double alfa = double.Parse(pmcol.txtalfa.Text);
                double d = t - cover;
                double Ac = b * t;
